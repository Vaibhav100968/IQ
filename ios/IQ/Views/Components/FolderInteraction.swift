    ...
    var body: some View {
        VStack(spacing: 6) {
            RoundedRectangle(cornerRadius: 4)
                .fill(Color(red: 0.81, green: 0.80, blue: 0.88))
                .frame(height: 6)
        ...
        .background(
            LinearGradient(
                colors: [
                    ...
                    Color(red: 0.86, green: 0.85, blue: 0.91)
                ],
                startPoint: .top,
                endPoint: .bottom
            )
        ...
        ZStack(alignment: .bottom) {
            ...
            .background(
                RoundedRectangle(cornerRadius: 10)
                    .fill(Color(red: 0.094, green: 0.082, blue: 0.106))
                    .shadow(color: Color(red: 0.31, green: 0.286, blue: 0.333).opacity(0.3), radius: 16, x: 0, y: 0)
            )
            ...
            FolderFlapShape()
                .fill(
                    LinearGradient(
                        colors: [
                            Color(red: 0.176, green: 0.145, blue: 0.208),
                ...
                .overlay(
                    FolderFlapShape()
                        .stroke(
                            LinearGradient(
                                colors: [
                                    Color(white: 0.26).opacity(0.04),
                                    Color(white: 0.13).opacity(0.3)
                                ],
                                startPoint: .top,
                                endPoint: .bottom
                            ),
